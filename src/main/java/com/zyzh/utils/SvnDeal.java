...
public class SvnDeal {
    ...
    private void addEntry(File wcPath) throws SVNException {
        try {
            clientManager.getWCClient().doAdd(new File[]{wcPath}, true, false,
                    false, SVNDepth.INFINITY, false, false, true);
        } catch (SVNException e) {
    ...
    private SVNCommitInfo commit(File wcPath, boolean keepLocks, String commitMessage) throws SVNException {
        try {
            return clientManager.getCommitClient().doCommit(new File[]{wcPath}, keepLocks, commitMessage,
    ...
    public static void main(String[] args) {
        try {
            String svnUrl = "https://192.168.1.9/s1vn";
            String username = "LiuWei1";
            String passwd = "123456";


            String url = "https://192.168.1.9/svn/SVN_PublicPlatForm/trunk/部门事务管理系统/01.开发库/010.项目立项";
...
//            System.out.println(svnDeal.isWorkingCopy(path));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
